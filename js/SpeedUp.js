   ...
   setInterval(function(){
    ...
    if(num>1){
      ...
      for(var i=0;i<lis.length;i++){
           ...
           lis1[i].style.cssText="height:40px;line-height:40px;color:#ccc;";
        }
        lis[num].style.opacity="1";
        lis1[num].style.cssText="height:50px;line-height:50px;color:#000;";
   },3000);
function shou(){
   for(var j=0;j<lis1.length;j++){
     ...
     lis1[j].onmousemove=function(){
        ...
        lis1[this.index].style.cssText="height:50px;line-height:50px;color:#000;";
        num=this.index;
    }
        }
    }
